...
# W, H = 480, 270
# crop_w, crop_h = 360, 210

# W, H = 240, 135
# crop_w, crop_h = 200, 90
...
for i, fid in enumerate(es_timestamps):
    ...
    points2d_ref_valid, point3D_from_ref, _, _ = get_3D_samples(points2d_query, query_depth_image, ref_T, rcamera)
