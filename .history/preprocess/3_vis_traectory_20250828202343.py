...
from vis_fov_view import batch_traj_two_with_axes_tour, extract_track_to_kml, convert_txt_to_czml
import simplekml
...
gt_czml = '/mnt/sda/MapScape/query/trajectory/' + seq_name.split('.')[0] + '_gt.czml'
es_czml = '/mnt/sda/MapScape/query/trajectory/' + seq_name.split('.')[0] + '_es.czml'
...
# 示例：提取 EST 和 GT
convert_txt_to_czml(trajectory_file, es_czml, simplekml.Color.yellow, name="EST")
convert_txt_to_czml(gt_file,  gt_gt_czmlkml,  simplekml.Color.blue,   name="GT")
