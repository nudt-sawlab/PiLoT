...
if __name__ == "__main__":
    folder2 = "/mnt/sda/MapScape/query/estimation/result_images/Render2loc/switzerland_seq7@8@foggy@intensity3@200"
    folder1 = "/media/ubuntu/PS20001/images/switzerland_seq7@8@foggy@intensity2@200"
    output_dir = "/mnt/sda/MapScape/query/estimation/result_images/Render2loc/atest"
