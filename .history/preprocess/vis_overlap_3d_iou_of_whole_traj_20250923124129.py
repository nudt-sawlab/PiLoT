...
voxel_size = 1.0   # 体素尺寸(米)，可调 0.5~2.0
...
# ======= 汇总 =======
print("\nSummary:")
print(f"Total pairs: {len(iou_list)}")
print(f"High (>=0.70): {len(bins['high'])}")
print(f"Mid  [0.40,0.70): {len(bins['mid'])}")
print(f"Low  (<0.40): {len(bins['low'])}")