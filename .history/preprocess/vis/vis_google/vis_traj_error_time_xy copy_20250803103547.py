...
for method, color in methods.items():
    if 'GT' not in method and 'raft' not in method: continue
...
# === 图属性 ===
ax.set_title(f"Position Error vs Frame Index", fontsize=16, fontweight='bold', family='serif')
ax.set_xlabel("Frame Index", fontsize=13, fontweight='bold', family='serif')
ax.set_ylabel("Position Error (m)", fontsize=13, fontweight='bold', family='serif')
ax.grid(True)
