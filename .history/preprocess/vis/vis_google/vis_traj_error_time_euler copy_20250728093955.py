...
from transform import WGS84_to_ECEF,wgs84tocgcs2000_batch,get_rotation_enu_in_ecef, cgcs2000towgs84_batch
...
est_xyz = cgcs2000towgs84_batch(est_xyz, 4547)
...
with open(save_path, 'w') as f:
    for i in range(len(est_xyz)):
        f.write(f"{est_frame_ids[i]} {est_xyz[i][0]} {est_xyz[i][1]} {est_xyz[i][2]} {est_angles[i][0]} {est_angles[i][1]} {est_angles[i][2]}\n")
