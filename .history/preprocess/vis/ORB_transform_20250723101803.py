    ...
    with open(file_path, 'r') as f:
        for line in f:
            ...
            if len(parts) >= 4:
                ...
                pose_dict_euler[fname] = list(map(float, parts[4:]))
...
ref_dict = load_pose_dict("/mnt/sda/MapScape/query/estimation/result_images/GT/USA_seq5@8@cloudy@300-100@200.txt")
orb_dict = load_pose_dict("/mnt/sda/MapScape/query/estimation/result_images/ORB@per30/USA_seq5@8@cloudy@300-100@200_1.txt")
...
all_orb_dict = load_pose_dict("/mnt/sda/MapScape/query/estimation/result_images/ORB@per30/USA_seq5@8@cloudy@300-100@200_1.txt")
all_orb_names = sorted(all_orb_dict.keys())
...
with open("/mnt/sda/MapScape/query/estimation/result_images/ORB@per30/USA_seq5@8@cloudy@300-100@200.txt", 'w') as f:
    for name, xyz in zip(all_orb_names, aligned_xyz):
        f.write(f"{name} {xyz[0]} {xyz[1]} {xyz[2]}\n")
