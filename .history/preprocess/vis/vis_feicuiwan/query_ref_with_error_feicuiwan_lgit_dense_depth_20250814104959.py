...
for method in methods:
    ref_dir   = "/mnt/sda/MapScape/query/estimation/mp4_compare/DJI_20250612194903_0021_V/GT"         # Render/Ref
    query_dir = os.path.join("/mnt/sda/MapScape/query/estimation/mp4_compare/DJI_20250612194903_0021_V/", method)  # Query
    output_path = os.path.join("/mnt/sda/MapScape/query/estimation/mp4_compare/DJI_20250612194903_0021_V/vis/pix_error_heat_vis")
