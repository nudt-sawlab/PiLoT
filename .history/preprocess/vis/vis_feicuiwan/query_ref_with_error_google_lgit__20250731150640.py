...
for method in methods:
    ...
    query_pose_file = os.path.join(query_dir, "switzerland_seq4@8@night@intensity3@500")
    ref_pose_file = os.path.join(ref_dir, "switzerland_seq4@8@night@intensity3@500")
