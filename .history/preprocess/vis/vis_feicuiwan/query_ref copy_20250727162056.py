...
# 配置
ref_dir = "/mnt/sda/MapScape/query/estimation/result_images/feicuiwan/Render_vis/GeoPixel"
query_dir = "/mnt/sda/MapScape/query/estimation/result_images/feicuiwan/Render_vis/Query"
output_path = "/mnt/sda/MapScape/query/estimation/result_images/feicuiwan/outputs"
start_idx, end_idx = 0, 900
fps = 25
...
for i in range(start_idx, end_idx + 1):
    ...
    # 添加文字说明
    draw_shadow_text(grid_mix, "Full Checkerboard Comparison", (30, 50), font_scale=1.2)
    draw_shadow_text(grid_mix, f"Frame {i}", (30, H - 30), font_scale=1.0)

    # 写入视频
    writer.write(grid_mix)
