...
points_npy = "/mnt/sda/MapScape/query/estimation/mp4_compare/DJI_20250612174308_0001_V/vis_video_with_error/clicked_points.npy"
for method in methods:
    ref_dir = "/mnt/sda/MapScape/query/estimation/mp4_compare/DJI_20250612174308_0001_V/GT"
    query_dir = os.path.join("/mnt/sda/MapScape/query/estimation/mp4_compare/DJI_20250612174308_0001_V/", method)
    output_path = os.path.join("/mnt/sda/MapScape/query/estimation/mp4_compare/DJI_20250612174308_0001_V/vis_video_with_error/" , method)
    query_pose_file = os.path.join(query_dir, "DJI_20250612174308_0001_V.txt")
    ref_pose_file = os.path.join(ref_dir, "DJI_20250612174308_0001_V.txt")
    start_idx, end_idx = 149, 149
