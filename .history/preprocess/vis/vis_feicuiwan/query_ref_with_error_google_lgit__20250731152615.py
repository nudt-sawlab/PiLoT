...
points_npy = "/mnt/sda/MapScape/query/estimation/mp4_compare/USA_seq5_six_mp4/vis_video_with_error/clicked_points.npy"
for method in methods:
    ref_dir = "/mnt/sda/MapScape/query/estimation/mp4_compare/USA_seq5_six_mp4/GT"
    query_dir = os.path.join("/mnt/sda/MapScape/query/estimation/mp4_compare/USA_seq5_six_mp4/", method)
    output_path = os.path.join("/mnt/sda/MapScape/query/estimation/mp4_compare/USA_seq5_six_mp4/vis_video_with_error/" , method)
    query_pose_file = os.path.join(query_dir, "USA_seq5@8@cloudy@300-100@200.txt")
    ref_pose_file = os.path.join(ref_dir, "USA_seq5@8@cloudy@300-100@200.txt")
    start_idx, end_idx = 600, 899
