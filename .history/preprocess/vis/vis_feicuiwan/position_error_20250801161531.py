...
import csv
import cv2
from transform import WGS84_to_ECEF, euler_angles_to_matrix_ECEF_w2c
from get_depth import get_3D_samples_v2
    ...
    with open(pose_file, 'r') as file:
        for line in file:
            ...
            if parts:  # Ensure the line is not empty
                ...
                R_c2w = euler_angles_to_matrix_ECEF_w2c(euler_angles, translation)
                break
...
def main():
    ...
    for txt_file in txt_files:
        ...
        for method_name, subfolder in methods.items():
            ...
            pose = get_poses(pose_file)
            xyz = get_es_xyz(result_file)
            euler_angles, translation = pose['0_0.png']
