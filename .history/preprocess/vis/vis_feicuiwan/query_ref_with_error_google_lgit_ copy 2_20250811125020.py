...
for method in methods:
    ...
    query_image_dir = "/mnt/sda/MapScape/query/estimation/mp4_compare/USA_seq5_foggy_gif/3840*2160_usa5"
    ...
    for i in range(start_idx, end_idx + 1):
        ...
        query_path = os.path.join(query_image_dir, f"{i}_0_{method}.png")
    ...
    #---
        ...
        qcamera = [3840, 2160, 4635.2, 4635.2, 1920.0, 1080.0]
        ...
        name = ref_dir.split('/')[-2]
        # frame = cv2.resize(frame, (480, 270))
        cv2.imwrite(f'{output_path}/{i}_{method}.png', frame, [cv2.IMWRITE_JPEG_QUALITY, 90])
