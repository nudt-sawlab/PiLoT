...
for method in methods:
    ref_dir = "/mnt/sda/MapScape/query/estimation/mp4_compare/switzerland_seq4_night/GT"
    query_dir = os.path.join("/mnt/sda/MapScape/query/estimation/mp4_compare/switzerland_seq4_night/", method)
    output_path = os.path.join("/mnt/sda/MapScape/query/estimation/mp4_compare/switzerland_seq4_night/vis_video_with_error/" , method)
