...
output_path = "/mnt/sda/MapScape/query/estimation/mp4_compare/USA_seq5_foggy_gif/vis_video/PixLoc"
...
for i in range(start_idx, end_idx + 1):
    ...
    # === 构造棋盘格混合区域 ===
    checker_crop = generate_checkerboard_overlay_transparent_v2(ref_crop, qry_crop, grid_rows, grid_cols)
