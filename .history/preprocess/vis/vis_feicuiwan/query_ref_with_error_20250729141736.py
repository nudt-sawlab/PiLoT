...
query_dir = "/mnt/sda/MapScape/query/estimation/mp4_compare/USA_seq5_foggy_gif/Render2ORB"
output_path = "/mnt/sda/MapScape/query/estimation/mp4_compare/USA_seq5_foggy_gif/vis_video/Render2ORB"
...
for i in range(start_idx, end_idx + 1):
    ...
    if i in es_timestamps:
        ...
        ang_str = f"Angle Error: {err_ang:.2f}°"
        ...
        # 阴影背景
        cv2.putText(checker_crop, pos_str, (pos_xy[0]+shadow_offset, pos_xy[1]+shadow_offset),
                    font, font_scale, (0, 0, 0), thickness + 2, cv2.LINE_AA)
        cv2.putText(checker_crop, ang_str, (ang_xy[0]+shadow_offset, ang_xy[1]+shadow_offset),
                    font, font_scale, (0, 0, 0), thickness + 2, cv2.LINE_AA)

        # 主文字
        cv2.putText(checker_crop, pos_str, pos_xy, font, font_scale, (255, 255, 255), thickness, cv2.LINE_AA)
        cv2.putText(checker_crop, ang_str, ang_xy, font, font_scale, (255, 255, 255), thickness, cv2.LINE_AA)
    ...
    cv2.imwrite(f'{output_path}/{i}_0.png', checker_crop)
