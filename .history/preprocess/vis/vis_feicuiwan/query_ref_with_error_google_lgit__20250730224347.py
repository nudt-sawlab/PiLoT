...
#---
    ...
    points2d_query_valid, point3D_from_query, _ = get_3D_samples_v2(points2d_query, query_depth_image, query_T, qcamera)
    points2d_ref, _, Points_3D_ECEF_origin, valid = get_points2D_ECEF_projection(np.array(ref_T), rcamera, point3D_from_query, points2d_query_valid, use_valid = False)   
