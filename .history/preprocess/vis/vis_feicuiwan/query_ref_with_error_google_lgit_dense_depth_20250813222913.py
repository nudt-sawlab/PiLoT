...
points_npy = "/mnt/sda/MapScape/query/estimation/mp4_compare/switzerland_seq4_night/vis_video_with_error/clicked_points.npy"

for method in methods:
    ref_dir   = "/mnt/sda/MapScape/query/estimation/mp4_compare/switzerland_seq4_night/GT"         # Render/Ref
    query_dir = os.path.join("/mnt/sda/MapScape/query/estimation/mp4_compare/switzerland_seq4_night/", method)  # Query
    output_path = os.path.join("/mnt/sda/MapScape/query/estimation/mp4_compare/switzerland_seq4_night/vis/pix_error_heat_vis")
    os.makedirs(output_path, exist_ok=True)

    query_pose_file = os.path.join(query_dir, "switzerland_seq4@8@night@intensity3@500.txt")
    ref_pose_file   = os.path.join(ref_dir,   "switzerland_seq4@8@night@intensity3@500.txt")
    ...
    for i in range(start_idx, end_idx + 1):
        ...
        overlay = overlay_heat_on_query(q_vis, heat_mag, valid_mask=valid, alpha=0.8)
