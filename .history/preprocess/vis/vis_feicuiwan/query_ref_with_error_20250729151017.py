...
output_path = "/mnt/sda/MapScape/query/estimation/mp4_compare/USA_seq5_foggy_gif/vis_video_with_error/Render2ORB"
...
for i in range(start_idx, end_idx + 1):
    ...
    if i in es_timestamps:
        ...
        if 'ORB' in query_dir or 'RAFT' in query_dir:
            key_xy = (ang_xy[0], ang_xy[1] + 40)  # 在 Angle Error 下面
        cv2.putText(frame, 'Keyframe', (key_xy[0] + shadow_offset, key_xy[1] + shadow_offset),
                    font, font_scale, (0, 0, 0), thickness + 2, cv2.LINE_AA)
        cv2.putText(frame, 'Keyframe', key_xy,
