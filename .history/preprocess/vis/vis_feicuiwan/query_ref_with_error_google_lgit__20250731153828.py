...
points_npy = "/mnt/sda/MapScape/query/estimation/mp4_compare/switzerland_seq7_rainy/vis_video_with_error/clicked_points.npy"
for method in methods:
    ref_dir = "/mnt/sda/MapScape/query/estimation/mp4_compare/switzerland_seq7_rainy/GT"
    query_dir = os.path.join("/mnt/sda/MapScape/query/estimation/mp4_compare/switzerland_seq7_rainy/", method)
    output_path = os.path.join("/mnt/sda/MapScape/query/estimation/mp4_compare/switzerland_seq7_rainy/vis_video_with_error/" , method)
    query_pose_file = os.path.join(query_dir, "switzerland_seq7@8@rainy@500.txt")
    ref_pose_file = os.path.join(ref_dir, "switzerland_seq7@8@rainy@500.txt")
