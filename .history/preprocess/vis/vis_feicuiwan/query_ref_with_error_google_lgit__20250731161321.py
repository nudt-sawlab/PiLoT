...
points_npy = "/mnt/sda/MapScape/query/estimation/mp4_compare/USA_seq8_sunnet/vis_video_with_error/clicked_points.npy"
for method in methods:
    ref_dir = "/mnt/sda/MapScape/query/estimation/mp4_compare/USA_seq8_sunnet/GT"
    query_dir = os.path.join("/mnt/sda/MapScape/query/estimation/mp4_compare/USA_seq8_sunnet/", method)
    output_path = os.path.join("/mnt/sda/MapScape/query/estimation/mp4_compare/USA_seq8_sunnet/vis_video_with_error/" , method)
    query_pose_file = os.path.join(query_dir, "USA_seq8@8@night@intensity1@500.txt")
    ref_pose_file = os.path.join(ref_dir, "USA_seq8@8@night@intensity1@500.txt")
