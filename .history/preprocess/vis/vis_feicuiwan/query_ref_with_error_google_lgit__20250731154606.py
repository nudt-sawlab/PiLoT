...
points_npy = "/mnt/sda/MapScape/query/estimation/mp4_compare/USA_seq2_cloudy/vis_video_with_error/clicked_points.npy"
for method in methods:
    ref_dir = "/mnt/sda/MapScape/query/estimation/mp4_compare/USA_seq2_cloudy/GT"
    query_dir = os.path.join("/mnt/sda/MapScape/query/estimation/mp4_compare/USA_seq2_cloudy/", method)
    output_path = os.path.join("/mnt/sda/MapScape/query/estimation/mp4_compare/USA_seq2_cloudy/vis_video_with_error/" , method)
