...
points_npy = "/mnt/sda/MapScape/query/estimation/mp4_compare/switzerland_seq12_sunny/vis_video_with_error/clicked_points.npy"
for method in methods:
    ref_dir = "/mnt/sda/MapScape/query/estimation/mp4_compare/switzerland_seq12_sunny/GT"
    query_dir = os.path.join("/mnt/sda/MapScape/query/estimation/mp4_compare/switzerland_seq12_sunny/", method)
    output_path = os.path.join("/mnt/sda/MapScape/query/estimation/mp4_compare/switzerland_seq12_sunny/vis_video_with_error/" , method)
    query_pose_file = os.path.join(query_dir, "switzerland_seq12@8@foggy@intensity2@200.txt")
    ref_pose_file = os.path.join(ref_dir, "switzerland_seq12@8@sunny@200.txt")
    start_idx, end_idx = 360, 390
