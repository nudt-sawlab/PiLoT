...
for recall_name, recall_idx in recall_indices.items():
    ...
    for _, method_label, values, color in method_lines:
        ax.plot(angles, values, label=method_label, color=color, linewidth=2, zorder=1)
        ax.fill(angles, values, color=color, alpha=0.5, zorder=0)  # 设置透明度
