...
def summarize_metrics(csv_path):
    df = pd.read_csv(csv_path, header=None, names=["Record", "Method", "MedianError", "StdError", "Recall@1m", "Recall@3m", "Recall@5m"])
    ...
    for method in methods:
        ...
        for env in environments:
            # 根据记录名提取环境条件
            env_data = method_data[method_data['Record'].str.contains(env)]
