...
for recall_name, recall_idx in recall_indices.items():
    ...
    for i, row in df.iterrows():
        ...
        color = methods_color[methods_name[method_key]]
        ...
        ax.plot(angles, values, label=method_label, color=color, linewidth=2)
    ...
    ax.set_title(recall_name, fontsize=16, pad=20)
    ax.legend(loc='upper right', bbox_to_anchor=(1.3, 1.1))
    
    plt.tight_layout()
    out_path = os.path.join(output_dir, f"radar_{recall_name}.png")
