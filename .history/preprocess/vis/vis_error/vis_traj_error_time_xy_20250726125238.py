...
for seq in seq_list:
    ...
    for method, color in methods.items():
        ...
        # 注释文本靠右侧自动对齐，不超图
        # 在当前方法循环中添加
        base_y = ax.get_ylim()[1] - 0.5     # 顶部起始位置（稍离图顶）
        line_spacing = 0.35                 # 每一行的垂直间距

        y_offset = base_y - method_display_order[method] * line_spacing

        text_x = frame_ids[0] + 5           # 左侧起点
        text_y = y_offset                   # 按顺序分配高度
