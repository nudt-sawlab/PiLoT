...
# 可见光图像路径（示例）
color_pth = '/home/ubuntu/Documents/code/FPVLoc/src_open/preprocess/datasets/Netherland_seq1/render_start/0_0.png'
# 深度图路径（示例），此处用 .npy 作为演示
depth_pth = '/home/ubuntu/Documents/code/FPVLoc/src_open/preprocess/datasets/Netherland_seq1/render_start/0_1.png'
