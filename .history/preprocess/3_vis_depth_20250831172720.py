...
# 可见光图像路径（示例）
color_pth = '/mnt/sda/MapScape/query/estimation/result_images/FPVLoc/switzerland_seq7@8@rainy@200/-1_0.png'
# 深度图路径（示例），此处用 .npy 作为演示
depth_pth = '/mnt/sda/MapScape/query/estimation/result_images/FPVLoc/switzerland_seq7@8@rainy@200/-1_0.png'
# depth_npy_pth = '/mnt/sda/MapScape/Train/France_seq1@200@30_50/ref/0_2.png'
...
depth_img = np.load(depth_pth[:-4]+'.png.npy')
near_cm = 10
far_cm = 2000
