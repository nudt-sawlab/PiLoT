...
def get_extended_rectangle_vertices(lon1, lat1, lon2, lat2, alt=0, half_width=300, extension=0):
    """
    给定两个经纬度点 (lon1, lat1) 与 (lon2, lat2)，构造一个矩形区域：
...
if __name__ == "__main__":
    # 示例经纬度：点 A 和点 B
    folder_path = "/home/ubuntu/Documents/code/FPVLoc/src_open/preprocess/dataset_CX"
