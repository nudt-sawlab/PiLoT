...
from vis_fov_view import batch_fov_visualization, batch_fov_visualization_with_error, batch_fov_visualization_with_error_tour
...
batch_fov_visualization_with_error_tour(trajectory_file, error_txt, kml_output)
