...
if __name__ == "__main__":
    ...
    query_rgb_path = os.path.join(folder_path, sequence_name,"query@sunset", "129_0.png")
    query_depth_path = os.path.join(folder_path, sequence_name,"query@sunset", "129_1.png")
