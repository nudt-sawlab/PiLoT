...
for seq in seq_list:
    ...
    for method, color in methods.items():
        ...
        xy_err[np.isnan(xy_err)] = 999
        plot_with_shaded_error(ax_alt, full_timestamps, xy_err, np.abs(xy_err), method, color)
        ...
        height_err[np.isnan(height_err)] = 999
        ...
        pitch_err[np.isnan(pitch_err)] = 180
        yaw_err = np.array(aligned_angles[:, 1] - angles_gt[:, 1])
        yaw_err[np.isnan(yaw_err)] = 180
