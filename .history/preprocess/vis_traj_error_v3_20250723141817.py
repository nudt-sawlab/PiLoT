...
for seq in seq_list:
    ...
    for method, color in methods.items():
        ...
        # 添加误差带
        plot_uncertainty_band(ax_poserr, full_timestamps, np.zeros_like(pos_err), pos_err, color)
        plot_uncertainty_band(ax_angerr, full_timestamps, np.zeros_like(ang_err), ang_err, color)
