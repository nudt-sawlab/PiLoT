...
def parallel_video_display(seq_dirs,
                           labels=('GT','FPVLoc  fps: 15','Pixloc  fps: 0.83','Render2loc  fps: 0.5'),
                           output_path=None,
                           target_size = (480, 270),
                           fps=20,
...
if __name__ == '__main__':
    ...
    sequences = [
        '/mnt/sda/MapScape/query/images/DJI_20250612194040_0013_V_900',
        '/mnt/sda/MapScape/query/estimation/result_images/FPVLoc/DJI_20250612194040_0013_V_900',
        '/mnt/sda/MapScape/query/estimation/result_images/Pixloc/DJI_20250612194040_0013_V_900',
