...
from vis_fov_view import batch_traj_with_axes_tour_gx, batch_fov_visualization_with_error, batch_fov_visualization_with_error_tour
...
batch_traj_with_axes_tour_gx(trajectory_file, error_txt, kml_output)
