...
from vis_fov_view import batch_traj_two_with_axes_tour, batch_fov_visualization_with_error, batch_fov_visualization_with_error_tour
...
batch_traj_two_with_axes_tour(trajectory_file, gt_file, error_txt, kml_output)
