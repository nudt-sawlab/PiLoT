...
if __name__ == "__main__":
    ...
    reference_rgb_path = os.path.join(folder_path, "images", sequence_name, "355_0.png")
    reference_depth_path = os.path.join(folder_path, "images",sequence_name, "355_1.png")
    query_rgb_path = os.path.join(folder_path, "images",sequence_name, "372_0.png")
    query_depth_path = os.path.join(folder_path, "images",sequence_name, "372_1.png")
