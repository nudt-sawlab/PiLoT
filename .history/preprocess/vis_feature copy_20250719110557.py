...
def visualize_feature_alignment_np(pt_path, save_path):
    data = load_pt_as_dict(pt_path)

    p2d_r = data["p2d_render"]
    p2d_q0 = data["p2d_query"]
    p2d_q1 = data["p2d_query_refined"]
    f_q = data["f_q"]  # shape: (3, C, H, W)
...
save_dir = "/mnt/data/feature_vis_outputs"
