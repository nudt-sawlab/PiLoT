...
for seq in seq_list:
    ...
    for method, color in methods.items():
        ...
        ax_pitch.plot(full_timestamps[valid_mask], aligned_angles[valid_mask, 0], color=color, linewidth=2, label=method)
    ...
    def update_inset(x0):
        ...
        for method, (ts, pitch, color) in all_pitch_data.items():
            ...
            axins.plot(ts[valid], pitch[valid], color=color, linewidth=2, label=method)
