...
# ---------- 主调用 ----------
pt_files = [
    "/home/ubuntu/Documents/code/github/FPV/FPV-Test-512-cuda/feature_vis_outputs/DJI_20241113180128_0042_D/0_DJI_20241113180128_0042_D_feature.pt",
    "/home/ubuntu/Documents/code/github/FPV/FPV-Test-512-cuda/feature_vis_outputs/DJI_20241113180128_0042_D/1_DJI_20241113180128_0042_D_feature.pt",
    "/home/ubuntu/Documents/code/github/FPV/FPV-Test-512-cuda/feature_vis_outputs/DJI_20241113180128_0042_D/2_DJI_20241113180128_0042_D_feature.pt",
]
save_dir = "/home/ubuntu/Documents/code/github/FPV/FPV-Test-512-cuda/feature_vis_outputs/DJI_20241113180128_0042_D"
os.makedirs(save_dir, exist_ok=True)

for i, pt_path in enumerate(pt_files):
    save_path = os.path.join(save_dir, f"feat_pair_L{i}.png")
    visualize_ref_query_pair(pt_path, save_path, level_name=f"L{i}", reduce='mean', out_size=(512, 288))
