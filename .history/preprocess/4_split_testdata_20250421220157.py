...
import argparse
import re
def split_photos_and_poses(input_dir, output_dir, pose_file, num_groups=5):
...
if __name__ == "__main__":
    input_dir = "/mnt/sda/MapScape/query/images/switzerland_seq4@8"
    output_dir = "/mnt/sda/MapScape/query/images/switzerland_seq4@8@foggy"
    pose_file = "/mnt/sda/MapScape/query/poses/switzerland_seq4@8.txt"
