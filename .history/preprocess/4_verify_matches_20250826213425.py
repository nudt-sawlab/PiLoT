...
if __name__ == "__main__":
    query_files = []
    folder_path = "/mnt/sda/MapScape/Train/"
    sequence_name = "France_seq1@200@30_50"
    reference_rgb_path = os.path.join(folder_path,sequence_name, "ref",  "355_0.png")
    reference_depth_path = os.path.join(folder_path, sequence_name, "ref","355_1.png")
    query_rgb_path = os.path.join(folder_path, sequence_name,"query@sunset", "369_0.png")
    query_depth_path = os.path.join(folder_path, sequence_name,"query@sunset", "369_1.png")
    pose_txt = os.path.join(folder_path, sequence_name, "France_seq1@200@30_50.txt")
