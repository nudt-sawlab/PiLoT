...
PYBIND11_MODULE(ModelRenderScene, m)
{
    ...
    py::class_<ModelRenderScene>(m, "ModelRenderScene")
        .def(py::init<std::string, uint32_t, uint32_t, double, double>())
        ...
        .def("getViewer", &ModelRenderScene::getViewer, py::return_value_policy::reference)
        .def("shutdown", &ModelRenderScene::shutdown);
