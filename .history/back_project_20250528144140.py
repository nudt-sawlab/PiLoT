...
import copy
# ---------- 小工具：高分辨率计时 ----------
def back_project(depth_frame, euler_angles, translation, num_samples = 200):
    # 
    ...
    Points_3D_ECEF, T_render_in_ECEF_w2c_modified, T_initial_pose_candidates, dd = get_3D_samples_v2(points2d, depth_frame, T_render_in_ECEF_c2w, self.render_camera,  euler_angles, translation, origin = [0,0,0], num_init_pose=200,mul = 0.01)
...
back_project(depth_frame=depth_frame, euler, trans)
