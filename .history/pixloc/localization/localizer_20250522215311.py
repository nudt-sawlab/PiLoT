...
class RenderLocalizer(Localizer):
    ...
    def run_query(self, name: str, camera: Camera, ref_camera: Camera, render_frame, query_T = None, render_T = None, Points_3D_ECEF = None, dd = None, gt_pose_dict = None, last_frame_info = {}, query_resize_ratio = 1,query_image=None):
        ret = self.refiner.refine_query_pose(name, camera, ref_camera, render_frame, query_T, render_T, Points_3D_ECEF, dd = dd, gt_pose_dict=gt_pose_dict,last_frame_info = last_frame_info, query_resize_ratio = query_resize_ratio,query_image= query_image)
        return ret
