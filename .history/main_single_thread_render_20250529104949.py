...
class DualThreadTask:
    ...
    def render_scene(self, euler_angles, translation):
        ...
        self.origin = torch.tensor(self.origin).to(self.device)
        Points_3D_ECEF1, T_render_in_ECEF_w2c_modified1, T_query_pose_candidates1,dd = self.back_project_v2(depth_image, euler_angles, translation, device = self.device)
    ...
    def back_project_v2(self, depth_frame, euler_angles, translation, num_samples = 200, device = 'cuda'):
        # 
        ...
        points2d = torch.tensor(np.load("points2d.npy")).to(device)
