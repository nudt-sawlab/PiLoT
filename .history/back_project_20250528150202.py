...
pose_dict = load_poses('/home/ubuntu/Documents/code/github/FPV/FPV-Test-512-cuda/outputs/FPVLoc@switzerland_seq4@8@sunny@500@512.txt')
...
for i in range(len(pose_dict)):
    euler, trans = pose_dict[i]
    depth_frame = depth_path + str(i) +'_0.npy'
