...
def back_project( depth_frame, euler_angles, translation, num_samples = 500, device = 'cuda'):
        ...
        Points_3D_ECEF, T_render_in_ECEF_w2c_modified, T_initial_pose_candidates, dd = get_3D_samples_v3(points2d, depth, T_render_in_ECEF_c2w, render_camera,  euler_angles, translation, origin = [111110,111110,111110], num_init_pose=500,mul = 0.001)
        # if dd is not None:
        #     self.dd = 
