...
# 加载数据
data = np.load("/home/ubuntu/Documents/code/github/FPV/FPV-Test-512-cuda/vis/data_seed_losses.npz")
...
for iter_idx in range(opt_euler.shape[0]):
    ...
    # 保存图像
    save_path = f"/home/ubuntu/Documents/code/github/FPV/FPV-Test-512-cuda/vis/euler_loss_iter{iter_idx+1}_pitch_yaw.png"
    plt.tight_layout()
