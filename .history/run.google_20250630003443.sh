...
read_pose_from_file() {
  local name="$1"
  local pose_file="/media/ubuntu/PS20001/poses/${name}.txt"
...
for target_name in "${target_names[@]}"; do
  ...
  if [[ $index -ge 0 ]]; then
    ...
    echo "--- targetloc"
    python /home/ubuntu/Documents/code/github/FPVLoc/main.py \
      --config "/home/ubuntu/Documents/code/github/FPVLoc/configs/google.yaml" \
      --init_euler "$euler" \
      --init_trans "$trans" \
      --name "$target_name"
