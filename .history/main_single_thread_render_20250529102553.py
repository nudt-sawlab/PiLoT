    ...
    def localization_thread(self):
        with open(self.estimated_pose, "w") as f:
            ...
            for frame in range(len(self.query_list)):
                ...
                Points_3D_ECEF1, T_render_in_ECEF_w2c_modified1, T_query_pose_candidates1 = self.back_project_v2(depth_frame, self.euler_angles, self.translation, device = self.device)
